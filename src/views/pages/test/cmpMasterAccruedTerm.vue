            ...
            <div class="col-xs-12">
              <button
                ...
                :disabled="
                  ...
                  this.todo.outstandingbudgetrealisasiq1 == null ||
                  this.todo.outstandingbudgetrealisasiq1 == '' ||
                  this.todo.outstandingbudgetaccruedq1 == null ||
                  this.todo.outstandingbudgetaccruedq1 == '' ||
                  this.todo.outstandingbudgetrealisasiq2 == null ||
                  this.todo.outstandingbudgetrealisasiq2 == '' ||
                  this.todo.outstandingbudgetaccruedq2 == null ||
                  this.todo.outstandingbudgetaccruedq2 == '' ||
                  this.todo.outstandingbudgetrealisasiq3 == null ||
                  this.todo.outstandingbudgetrealisasiq3 == '' ||
                  this.todo.outstandingbudgetaccruedq3 == null ||
                  this.todo.outstandingbudgetaccruedq3 == '' ||
                  this.todo.outstandingbudgetrealisasiq4 == null ||
                  this.todo.outstandingbudgetrealisasiq4 == '' ||
                  this.todo.outstandingbudgetaccruedq4 == null ||
                  this.todo.outstandingbudgetaccruedq4 == '' ||
                  ...
                  this.todo.accrued_q1 == null ||
                  this.todo.accrued_q1 == '' ||
                  this.todo.q2 == null ||
                  this.todo.q2 == '' ||
                  this.todo.realizationq2 == null ||
                  this.todo.realizationq2 == '' ||
                  this.todo.accrued_q2 == null ||
                  this.todo.accrued_q2 == '' ||
                  this.todo.q3 == null ||
                  this.todo.q3 == '' ||
                  this.todo.realizationq3 == null ||
                  this.todo.realizationq3 == '' ||
                  this.todo.accrued_q3 == null ||
                  this.todo.accrued_q3 == '' ||
                  this.todo.q4 == null ||
                  this.todo.q4 == '' ||
                  this.todo.realizationq4 == null ||
                  this.todo.realizationq4 == '' ||
                  this.todo.accrued_q4 == null ||
                  this.todo.accrued_q4 == ''
                "
              >
                <i
...
export default {
  ...
  data() {
    return {
      ...
      errorField: {
        ...
        accrued_q3: false,
        accrued_q4: false,
        outstandingbudgetrealisasiq1: false,
        outstandingbudgetaccruedq1: false,
        outstandingbudgetrealisasiq2: false,
        outstandingbudgetaccruedq2: false,
        outstandingbudgetrealisasiq3: false,
        outstandingbudgetaccruedq3: false,
        outstandingbudgetrealisasiq4: false,
        outstandingbudgetaccruedq4: false,
      },
      ...
      todo: {
        ...
        accrued_q4: "",
        accrued_q4: "",
        outstandingbudgetaccruedq1: "",
        outstandingbudgetrealisasiq1: "",
        outstandingbudgetaccruedq2: "",
        outstandingbudgetrealisasiq2: "",
        outstandingbudgetaccruedq3: "",
        outstandingbudgetrealisasi3: "",
        outstandingbudgetaccruedq4: "",
        outstandingbudgetrealisasiq4: "",
      },
      flagButtonAdd: true,
      csv: null,
      dataImportCsv: {
        ...
        outstandingbudgetaccruedq1: {
          label: "outstandingbudgetaccruedq1",
          required: true,
        },
        outstandingbudgetrealisasiq1: {
          label: "outstandingbudgetrealisasiq1",
          required: true,
        },
        outstandingbudgetaccruedq2: {
          label: "outstandingbudgetaccruedq2",
          required: true,
        },
        outstandingbudgetrealisasiq2: {
          label: "outstandingbudgetrealisasiq2",
          required: true,
        },
        outstandingbudgetaccruedq3: {
          label: "outstandingbudgetaccruedq3",
          required: true,
        },
        outstandingbudgetrealisasi3: {
          label: "outstandingbudgetrealisasi3",
          required: true,
        },
        outstandingbudgetaccruedq4: {
          label: "outstandingbudgetaccruedq4",
          required: true,
        },
        outstandingbudgetrealisasiq4: {
          label: "outstandingbudgetrealisasiq4",
          required: true,
        },
      },
      data_x_tabel: [],
      ...
      json_fields: {
        ...
        accrued_q1: "accrued_q1",
        accrued_q2: "accrued_q2",
        accrued_q3: "accrued_q3",
        accrued_q4: "accrued_q4",
        outstandingbudgetaccruedq1: "outstandingbudgetaccruedq1",
        outstandingbudgetrealisasiq1: "outstandingbudgetrealisasiq1",
        outstandingbudgetaccruedq2: "outstandingbudgetaccruedq2",
        outstandingbudgetrealisasiq2: "outstandingbudgetrealisasiq2",
        outstandingbudgetaccruedq3: "outstandingbudgetaccruedq3",
        outstandingbudgetrealisasi3: "outstandingbudgetrealisasi3",
        outstandingbudgetaccruedq4: "outstandingbudgetaccruedq4",
        outstandingbudgetrealisasiq4: "outstandingbudgetrealisasiq4",
      },
      nama_Worksheet: "Sheet Master Accrued Term",
      nama_excelnya: "",
      nama_sheetnya: "",
    };
  },
  ...
  methods: {
    ...
    async getDataExportExcel() {
        ...
        Object.keys(resData.results).forEach(function (key) {
          const countries_x = {
            ...
            realizationq4: resData.results[key].realizationq4
              ...
              : "",
            accrued_q1: resData.results[key].accrued_q1
              ? resData.results[key].accrued_q1
              : "",
            accrued_q2: resData.results[key].accrued_q2
              ? resData.results[key].accrued_q2
              : "",
            accrued_q3: resData.results[key].accrued_q3
              ? resData.results[key].accrued_q3
              : "",
            accrued_q4: resData.results[key].accrued_q4
              ? resData.results[key].accrued_q4
              : "",
            outstandingbudgetaccruedq1: resData.results[key]
              .outstandingbudgetaccruedq1
              ? resData.results[key].outstandingbudgetaccruedq1
              : "",
            outstandingbudgetrealisasiq1: resData.results[key]
              .outstandingbudgetrealisasiq1
              ? resData.results[key].outstandingbudgetrealisasiq1
              : "",
            outstandingbudgetaccruedq2: resData.results[key]
              .outstandingbudgetaccruedq2
              ? resData.results[key].outstandingbudgetaccruedq2
              : "",
            outstandingbudgetrealisasiq2: resData.results[key]
              .outstandingbudgetrealisasiq2
              ? resData.results[key].outstandingbudgetrealisasiq2
              : "",
            outstandingbudgetaccruedq3: resData.results[key]
              .outstandingbudgetaccruedq3
              ? resData.results[key].outstandingbudgetaccruedq3
              : "",
            outstandingbudgetrealisasi3: resData.results[key]
              .outstandingbudgetrealisasiq3
              ? resData.results[key].outstandingbudgetrealisasiq3
              : "",
            outstandingbudgetaccruedq4: resData.results[key]
              .outstandingbudgetaccruedq4
              ? resData.results[key].outstandingbudgetaccruedq4
              : "",
            outstandingbudgetrealisasiq4: resData.results[key]
              .outstandingbudgetrealisasiq4
              ? resData.results[key].outstandingbudgetrealisasiq4
              : "",
          };
      ...
      mythis.nama_excelnya = "MASTER_ACCRUED_TERM_" + a + ".xls";
          ...
          axios
            .post(
              url,
              {
                ...
                accrued_q1: mythis.todo.accrued_q1,
                accrued_q2: mythis.todo.accrued_q2,
                accrued_q3: mythis.todo.accrued_q3,
                accrued_q4: mythis.todo.accrued_q4,
                outstandingbudgetaccruedq1:
                  mythis.todo.outstandingbudgetaccruedq1,
                outstandingbudgetrealisasiq1:
                  mythis.todo.outstandingbudgetrealisasiq1,
                outstandingbudgetaccruedq2:
                  mythis.todo.outstandingbudgetaccruedq2,
                outstandingbudgetrealisasiq2:
                  mythis.todo.outstandingbudgetrealisasiq2,
                outstandingbudgetaccruedq3:
                  mythis.todo.outstandingbudgetaccruedq3,
                outstandingbudgetrealisasi3:
                  mythis.todo.outstandingbudgetrealisasi3,
                outstandingbudgetaccruedq4:
                  mythis.todo.outstandingbudgetaccruedq4,
                outstandingbudgetrealisasiq4:
                  mythis.todo.outstandingbudgetrealisasiq4,
                userid: mythis.userid,
              },
              config
            )
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        columns: [
          ...
          "No",
          "KODE BEBAN",
          "BUDGET Q1", // Kuartal 1 = Jan + Feb + Mar
          "REALIZATION Q1",
          "REALISASI ACCRUED Q1", // Realisasi Accrued Kuartal 1
          "OUTSTANDING BUDGET REALIZATION Q1", // Outstanding Budget Realization Kuartal 1
          "OUTSTANDING BUDGET ACCRUED Q1", // Outstanding Budget Accrued Kuartal 1
          "BUDGET Q2", // Kuartal 2 = Apr + Mei + Jun
          "REALIZATION Q2",
          "REALISASI ACCRUED Q2", // Realisasi Accrued Kuartal 2
          "OUTSTANDING BUDGET REALIZATION Q2", // Outstanding Budget Realization Kuartal 2
          "OUTSTANDING BUDGET ACCRUED Q2", // Outstanding Budget Accrued Kuartal 
          "BUDGET Q3", // Kuartal 3 = Jul + Ags + Sep
          "REALIZATION Q3",
          "REALISASI ACCRUED Q3", // Realisasi Accrued Kuartal 3
          "OUTSTANDING BUDGET REALIZATION Q3", // Outstanding Budget Realization Kuartal 3
          "OUTSTANDING BUDGET ACCRUED Q3", // Outstanding Budget Accrued Kuartal 3
          "BUDGET Q4", // Kuartal 4 = Okt + Nop + Des
          "REALIZATION Q4",
          "REALISASI ACCRUED Q4", // Realisasi Accrued Kuartal 4
          "OUTSTANDING BUDGET REALIZATION Q4", // Outstanding Budget Realization Kuartal 4
          "OUTSTANDING BUDGET ACCRUED Q4", // Outstanding Budget Accrued Kuartal 4
        ...
        server: {
          url: this.$root.apiHost + "api/accruedterm",
          then: (data) =>
            data.results.map((card) => [
              ...
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.accrued_q1)}</span>`
              ), // Accrued Kuartal 1
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetrealisasiq1)}</span>`
              ), // Outstanding Budget Realisasi Kuartal 1
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetaccruedq1)}</span>`
              ), // Outstanding Budget Accrued Kuartal 1
              ...
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.accrued_q2)}</span>`
              ), // Accrued Kuartal 2
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetrealisasiq2)}</span>`
              ), // Outstanding Budget Realisasi Kuartal 2
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetaccruedq2)}</span>`
              ), // Outstanding Budget Accrued Kuartal 2
              ...
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.accrued_q3)}</span>`
              ), // Accrued Kuartal 3
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetrealisasiq3)}</span>`
              ), // Outstanding Budget Realisasi Kuartal 3
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetaccruedq3)}</span>`
              ), // Outstanding Budget Accrued Kuartal 3
              ...
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.accrued_q4)}</span>`
              ), // Accrued Kuartal 4
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetrealisasiq4)}</span>`
              ), // Outstanding Budget Realisasi Kuartal 4
              html(
                `<span class="pull-left">${new Intl.NumberFormat(
                  "en-US"
                ).format(card.outstandingbudgetaccruedq4)}</span>`
              ), // Outstanding Budget Accrued Kuartal 4
            ]),
      ...
      axios
        .put(
          mythis.$root.apiHost + "api/BudgetMonitoring/" + mythis.todo.id,
          {
            ...
            realizationq4: mythis.todo.realizationq4, // Realisasi Kuartal 4 (Realization N10 + N11 + N12)
            accrued_q1: mythis.todo.accrued_q1, // Accrued Kuartal 1
            accrued_q2: mythis.todo.accrued_q2, // Accrued Kuartal 2
            accrued_q3: mythis.todo.accrued_q3, // Accrued Kuartal 3
            accrued_q4: mythis.todo.accrued_q4, // Accrued Kuartal 4
            outstandingbudgetaccruedq1: mythis.todo.outstandingbudgetaccruedq1, // Outstanding Budget Accrued Q1
            outstandingbudgetrealisasiq1:
              mythis.todo.outstandingbudgetrealisasiq1, // Outstanding Budget Realisasi Q1
            outstandingbudgetaccruedq2: mythis.todo.outstandingbudgetaccruedq2, // Outstanding Budget Accrued Q2
            outstandingbudgetrealisasiq2:
              mythis.todo.outstandingbudgetrealisasiq2, // Outstanding Budget Realisasi Q2
            outstandingbudgetaccruedq3: mythis.todo.outstandingbudgetaccruedq3, // Outstanding Budget Accrued Q3
            outstandingbudgetrealisasiq3:
              mythis.todo.outstandingbudgetrealisasiq3, // Outstanding Budget Realisasi Q3
            outstandingbudgetaccruedq4: mythis.todo.outstandingbudgetaccruedq4, // Outstanding Budget Accrued Q4
            outstandingbudgetrealisasiq4:
              mythis.todo.outstandingbudgetrealisasiq4, // Outstanding Budget Realisasi Q4
            userid: mythis.userid,
          },
          config
        )
    ...
    async getData(id) {
      ...
      await axios
        ...
        .then(async (res) => {
          ...
          mythis.todo.realizationq4 = res.data.data.realizationq4; // Realisasi Q4 (Realization N10 + N11 + N12)
          mythis.todo.accrued_q1 = res.data.data.accrued_q1; // Accrued Q1
          mythis.todo.accrued_q2 = res.data.data.accrued_q2; // Accrued Q2
          mythis.todo.accrued_q3 = res.data.data.accrued_q3; // Accrued Q3
          mythis.todo.accrued_q4 = res.data.data.accrued_q4; // Accrued Q4
          mythis.todo.outstandingbudgetaccruedq1 =
            res.data.data.outstandingbudgetaccruedq1; // Outstanding Budget Accrued Q1
          mythis.todo.outstandingbudgetrealisasiq1 =
            res.data.data.outstandingbudgetrealisasiq1; // Outstanding Budget Realisasi Q1
          mythis.todo.outstandingbudgetaccruedq2 =
            res.data.data.outstandingbudgetaccruedq2; // Outstanding Budget Accrued Q2
          mythis.todo.outstandingbudgetrealisasiq2 =
            res.data.data.outstandingbudgetrealisasiq2; // Outstanding Budget Realisasi Q2
          mythis.todo.outstandingbudgetaccruedq3 =
            res.data.data.outstandingbudgetaccruedq3; // Outstanding Budget Accrued Q3
          mythis.todo.outstandingbudgetrealisasiq3 =
            res.data.data.outstandingbudgetrealisasiq3; // Outstanding Budget Realisasi Q3
          mythis.todo.outstandingbudgetaccruedq4 =
            res.data.data.outstandingbudgetaccruedq4; // Outstanding Budget Accrued Q4
          mythis.todo.outstandingbudgetrealisasiq4 =
            res.data.data.outstandingbudgetrealisasiq4; // Outstanding Budget Realisasi Q4
