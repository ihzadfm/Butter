...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        brandcode: "brandcode", // Kode brand

        brandname: "brandname", // Nama brand

        itemcode: "itemcode", // Kode item

        mtgcode: "mtgcode", // Kode MTG

        parentcode: "parentcode", // Kode parent

        itemname: "itemname", // Nama item
      },

      nama_Worksheet: "Sheet Master PRODUCT",
  ...
  methods: {
        ...
        if (result.isConfirmed) {
          ...
          try {
            const response = await axios.delete(
              mythis.$root.apiHost + "api/masterproductdelete",
              config
            );
    ...
    async getDataExportExcel() {
      ...
      mythis.nama_excelnya = "MASTER_PRODUCT_" + a + ".xls";
    ...
    saveTodoBulky() {
      ...
      Swal.fire({
        title: "Create Master Product Bulky",
        text: "Are you sure?",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/masterproductBulky";
          axios
            .post(
              url,
              {
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/masterproduct";
          axios
            .post(
              url,
              {
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHost + "api/masterproduct",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios
            .delete(mythis.$root.apiHost + `api/masterproduct/${id}`, config)
            .then((res) => {
    ...
    editTodo() {
      ...
      axios
        .put(
          mythis.$root.apiHost + "api/masterproduct/" + mythis.todo.id,
          {
            brandcode: mythis.todo.brandcode,
            brandname: mythis.todo.brandname,
            itemcode: mythis.todo.itemcode,
    ...
    async getData(id) {
      ...
      await axios
        .get(mythis.$root.apiHost + `api/masterproduct/${id}`, config)
        .then(async (res) => {
          //console.log(res.data.data);
          //mythis.acuanEdit = id;
