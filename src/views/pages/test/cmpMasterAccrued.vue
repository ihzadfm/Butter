  ...
  data() {
    return {
      ...
      json_fields: {
        ...
        kode_beban: "kode_beban", // Kode beban
      ...
      while (count > 0) {
        ...
        Object.keys(resData.results).forEach(function (key) {
          const countries_x = {
            ...
            kode_beban: resData.results[key].kode_beban,
          ...
          axios
            .post(
              url,
              {
                ...
                kode_beban: mythis.todo.kode_beban,
        ...
        server: {
          ...
          then: (data) =>
            data.results.map((card) => [
              ...
              html(`<span class="pull-left">${card.kode_beban}</span>`),
              html(
    ...
    async getData(id) {
      ...
      await axios
        ...
        .then(async (res) => {
          ...
          mythis.todo.kode_beban = res.data.data.kode_beban;
