        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Kode Beban</label>
                  <CmpInputText
                    type="text"
...
export default {
  ...
  methods: {
        ...
        if (result.isConfirmed) {
          ...
          try {
            const response = await axios.delete(
              mythis.$root.apiHost + "api/bridgingbudgetbranddelete",
              config
            );
    ...
    saveTodoBulky() {
      ...
      Swal.fire({
        title: "Create Master Bridging Bulky",
        text: "Are you sure?",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/bridgingbudgetbrandBulky";
          axios
            .post(
              url,
              {
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/bridgingbudgetbrand";
          axios
            .post(
              url,
              {
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHost + "api/bridgingbudgetbrand",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios
            .delete(
              mythis.$root.apiHost + `api/bridgingbudgetbrand/${id}`,
              config
            )
            .then((res) => {
    ...
    async getData(id) {
      ...
      await axios
        .get(mythis.$root.apiHost + `api/bridgingbudgetbrand/${id}`, config)
        .then(async (res) => {
          //console.log(res.data.data);
          //mythis.acuanEdit = id;
